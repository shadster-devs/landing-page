  ...
  return (
    <div className="flex flex-col h-[calc(100vh-65px)] overflow-hidden bg-[var(--bg)]">
      ...
      <div className="flex flex-1 overflow-hidden editor-container">
        ...
        {/* Theme panel - Coming Soon */}
        {showThemePanel && (
          <motion.aside
            className="border-l border-[var(--border)] overflow-y-auto bg-[var(--card)] transition-all duration-300"
            ...
            <div className="p-4 space-y-6">
              ...
              <div className="space-y-3 mt-6">
                ...
                <div className="text-center py-8 space-y-3">
                  ...
                  <div className="text-xs text-[var(--muted)]">Create and customize your own diagram themes with CSS and variables.</div>
