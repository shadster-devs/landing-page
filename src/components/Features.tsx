...
const features = [
  {
    ...
    description: "Automatically detects Mermaid diagram code in ChatGPT responses with advanced monitoring for class changes and content updates."
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    description: "Switch seamlessly between diagram and source code views with a single click, perfect for learning and editing."
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    description: "Dynamic timeout based on content complexity ensures proper rendering of even the most complex diagrams with Mermaid.js v11.9.0."
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M20.88 18.09C21.7494 17.4786 22.4014 16.6061 22.7413 15.5991C23.0812 14.5921 23.0914 13.503 22.7708 12.4898C22.4502 11.4766 21.8139 10.5921 20.9561 9.96456C20.0983 9.33703 19.0628 8.99916 18 9.00001H16.74C16.4392 7.82822 15.8765 6.7393 15.0941 5.81253C14.3117 4.88575 13.3321 4.14716 12.2299 3.65914C11.1276 3.17112 9.93378 2.94498 8.73453 2.99602C7.53528 3.04706 6.36304 3.37432 5.31103 3.95354C4.25902 4.53275 3.35863 5.34968 2.67491 6.33935C1.99119 7.32902 1.53993 8.46564 1.35935 9.65841C1.17877 10.8512 1.27398 12.0693 1.63711 13.2152C2.00023 14.3611 2.62221 15.4035 3.45 16.25" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
    title: "Copy & Download",
    description: "Export diagrams as PNG images or copy them to clipboard with a single click, complete with CORS protection for seamless sharing."
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    description: "Graceful error handling with detailed feedback when diagrams can't be rendered, helping you quickly identify and fix syntax issues."
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    description: "Automatically adapts to ChatGPT's light and dark themes for a seamless visual experience that matches your preferred mode."
  },
];
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Transform your ChatGPT experience with beautiful, interactive diagrams that make complex concepts clear. Worth every penny of the $10 one-time fee.
          </motion.p>
        </motion.div>
